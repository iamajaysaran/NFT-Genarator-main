...
const namePrefix = "Pandora";
const description = "this is a cool NFT Collections project";
...
const extraMetadata = {// Replace with your website or remove this line if you do not have one.
};

// NFTPort Info
// ** REQUIRED **
const AUTH = "9b825d0bac1544eca1c15b6e8aaec698";
const LIMIT = 2; // Your API key rate limit
const CONTRACT_NAME = 'Pandora';
const CONTRACT_SYMBOL = 'Pnd';
const CONTRACT_TYPE = 'erc721';
const MINT_TO_ADDRESS = '0x3AeDbc51DE4ea9b729910C58A0eeA890e62bB50f';
const CHAIN = 'rinkeby';
const METADATA_UPDATABLE = true; // set to false if you don't want to allow metadata updates after minting
const ROYALTY_SHARE = 1000; // Percentage of the token price that goes to the royalty address. 100 bps = 1%
const ROYALTY_ADDRESS = "0x3AeDbc51DE4ea9b729910C58A0eeA890e62bB50f"; // Address that will receive the royalty
// ** OPTIONAL **
